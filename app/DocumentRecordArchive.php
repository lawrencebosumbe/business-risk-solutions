...
class File extends Model
{
    ...
    */
    ...
    protected $fillable = [
    	...
    	'url', 'doc_number', 'originator', 'owner', 'reviewer', 'department', 'location', 'additional_security', 'revision', 'electronic_distribution', 'hardcopy', 'category', 'system_element', 'due_date', 'original_date', 'effective_date', 'resource_date', 'review_date',
    ];
