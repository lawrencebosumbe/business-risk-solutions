                                ...
                                <div class="col-xs-12 col-md-12">
                                  ...
                                  <ul class="navbar-nav ml-auto file">
                                    <li class="nav-item dropdown">
                                      ...
                                      <div class="dropdown-menu ellipsis-topbar-dropdown-menu">
                                      <a class="dropdown-item" href="{{ route('folders.file', $file->id) }}">See Prview</a>
                                      <a class="dropdown-item" href="" download>Download</a>
                                      <a class="dropdown-item" href="#">Rename</a>
                                      <a class="dropdown-item" href="{{ route('folders.delete_file', $file->id) }}" onclick="return confirm('Are you sure you want to delete {{ $file->filename }} ?')">
                                          Delete
                                      </a>
                                      <div class="dropdown-divider"></div>
