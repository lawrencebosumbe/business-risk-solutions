...
<html lang="en">
  <head>
    ...
    <link href="{{asset('event/css/bootstrap-datetimepicker.css')}}" rel="stylesheet">
    <link href="{{asset('event/css/custom.css')}}" rel="stylesheet">
  </head>
  ...
  <body>
    ...
    <script src="{{asset('event/js/parsley.js')}}"></script>
