  ...
  <nav class="main-header navbar navbar-expand navbar-light navbar-bg-silver">
    ...
    <!-- Authentication Links -->
      ...
      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
        ...
        <a class="dropdown-item" href="{{ route('files.settings') }}">Settings</a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('files.my_discussions') }}" class="nav-link">
                  <i class="fas fa-comments nav-icon"></i>
                  <p>My Discussions</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('files.my_tasks') }}" class="nav-link">
                  <i class="fas fa-paste nav-icon"></i>
                  <p>My Tasks</p>
                </a>
              </li>
                ...
                <div class="card">
                  ...
                  <div class="card-header card-header-sub-top d-flex p-0">
                    ...
                    <ul class="nav nav-pills ml-auto p-2">
                      <li class="nav-item">
                        <a class="nav-link" href="{{ route('files.create_folder') }}" >Add Folder
                        </a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="{{ route('files.create_file') }}">Add File
                        </a>
                      </li>
                      <li class="nav-item">
                  ...
                  <table class="table">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th></th>
                        <th style="width: 40px;"> 
                          <a href="{{ route('files.delete_note', $note->id) }}"
