...
/*-----------------------------*/
.breadcrumb-li li:nth-child(7) a {
  background: #28a745;
  color: #fff;
  cursor: pointer;
}

.breadcrumb-li li:nth-child(7) a:hover {
  background: #ffffff;
  color: #28a745;
}

.breadcrumb-li li:nth-child(7) a:after {
  border-left-color: #28a745;
}

.breadcrumb-li li:nth-child(7) a:hover:after {
  border-left-color: #ffffff;
}
            ...
            <div class="col-12">
                ...
                <!-- .card-header -->
                  <div class="card-header card-header-sub-bottom d-flex p-0">
                    <ul class="breadcrumb card-title p-3">
                      ...
                      <li class="color-primary">Release</li>
                    </ul>
                  </div>
                  <!-- /.card-header -->
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <!-- form -->
                  <form method="post" action="{{ route('document_control.insert_release') }}" enctype="multipart/form-data">
                    @csrf
                  <!-- .card -->
                        ...
                        <div class="col-md-12">
                          <section class="content-header">
                            ...
                            <div class="container-fluid"><br/><br/>
                              <div class="row mb-2">
                                <div class="col-sm-2">
                                  @foreach($release_files as $approval)
                                  <input type="hidden" name="file_id" value="{{ $approval->file_id }}">
                                  <input type="hidden" name="awaiting_release_id" value="{{ $approval->awaiting_release_id }}">
