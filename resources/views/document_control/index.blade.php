                            ...
                            <div class="row mb-2">
                              ...
                              <div class="col-sm-6">
                                <div class="row">
                                  ...
                                  <div class="col-md-3">
                                    <input type="text" class="form-control hide-controls" style="width: 100%; margin-top: 25px; margin-left: -75px" name="">
                                  </div>
                                  <div class="col-md-3">
                                    <label style="margin-top: 30px" class="form-check-label hide-controls">
                                      Delay Unit
                                  ...
                                  <div class="col-md-3">
                                    <select class="custom-select form-control hide-controls" style="width: 100%; margin-top: 25px; margin-left: -35px" name="">
                                      <option>1</option>
                                      <option>2</option>
                                      <option>3</option>
                                      <option>4</option>
