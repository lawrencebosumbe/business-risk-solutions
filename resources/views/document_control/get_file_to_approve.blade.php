          ...
          <li class="nav-item has-treeview my-organization menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item active">
                ...
                <li class="nav-item active">
                <a href="{{ route('document_control.document_by_title') }}" class="nav-link">
                ...
                <!-- .card-header -->
                  <div class="card-header card-header-sub-bottom d-flex p-0">
                    <ul class="breadcrumb card-title p-3">
                      ...
                      <li class="color-primary">Full Document</li>
                    </ul>
                  </div>
                  <!-- /.card-header -->
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-sm-3">
                          ...
                          <a href="/">
                            <input type="text" name="url" class="form-control" value="{{ $approval->url }}">
                          </a>
                        </div>
