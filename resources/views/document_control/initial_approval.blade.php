...
/*-----------------------------*/
.breadcrumb-li li:nth-child(3) a {
  background: #28a745;
  color: #fff;
  cursor: pointer;
}

.breadcrumb-li li:nth-child(3) a:hover {
  background: #ffffff;
  color: #28a745;
}

.breadcrumb-li li:nth-child(3) a:after {
  border-left-color: #28a745;
}

.breadcrumb-li li:nth-child(3) a:hover:after {
  border-left-color: #ffffff;
}
            ...
            <div class="col-12">
                ...
                <!-- .card-header -->
                  <div class="card-header card-header-sub-bottom d-flex p-0">
                    <ul class="breadcrumb card-title p-3">
                      ...
                      <li class="color-primary">Initial Approval</li>
                    </ul>
                  </div>
                  <!-- /.card-header -->
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <!-- form -->
                  <form method="post" action="{{ route('document_control.insert_initial_approval') }}" enctype="multipart/form-data">
                    @csrf
                  <!-- .card -->
                            ...
                            <div class="container-fluid"><br/><br/>
                              <div class="row mb-2">
                                <div class="col-sm-2">
                                  ...
                                  <input type="text" name="revision" class="form-control" value="3" readonly>
                                  @foreach($approval_files as $approval)
                                  <input type="hidden" name="{{ $approval->doc_number }}">
                                  <input type="hidden" name="file_id" value="{{ $approval->file_id }}">
                                  <input type="hidden" name="document_control_review_id" value="{{ $approval->document_control_review_id }}">
                                ...
                                <div class="col-sm-6">
                                  ...
                                  <input type="text" name="approval_date" class="form-control" id="approval_datepicker">
                                </div>
                              </div>
                            </div>
                            <!-- /.container-fluid -->
