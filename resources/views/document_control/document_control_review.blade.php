...
<head>
  ...
  <title>Document Control Review</title>
  <!-- Bootstrap 4 -->
...
/*-----------------------------*/
.breadcrumb-li li:nth-child(2) a {
  background: #28a745;
  color: #fff;
  cursor: pointer;
}

.breadcrumb-li li:nth-child(2) a:hover {
  background: #ffffff;
  color: #28a745;
}

.breadcrumb-li li:nth-child(2) a:after {
  border-left-color: #28a745;
}

.breadcrumb-li li:nth-child(2) a:hover:after {
  border-left-color: #ffffff;
}
/*-----------------------------*/
  .lc li a{
            ...
            <div class="col-12">
                ...
                <!-- .card-header -->
                  <div class="card-header card-header-sub-bottom d-flex p-0">
                    <ul class="breadcrumb card-title p-3">
                      ...
                      <li class="color-primary">Document Control Review</li>
                    </ul>
                  </div>
                  <!-- /.card-header -->
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <!-- form -->
                  <form method="post" action="{{ route('document_control.insert_doc_control_review') }}" enctype="multipart/form-data">
                    @csrf
                  <!-- .card -->
                  <div class="card">
                    <!-- .card-header -->
                          ...
                          <section class="content-header">
                            ...
                            <div class="container-fluid"><br/><br/>
                              <div class="row mb-1">
                                <!--
                                @if(!empty($files))
                                <select class="form-control" name="file_id" hidden>
                              ...
                              -->
                                ...
                                <div class="col-sm-2">
                                  ...
                                  <select class="form-control" name="file_id">
                                      @foreach($files as $file)
                                      <option value="{{$file->id}}">{{$file->doc_number}}</option>
                                      @endforeach
                                    </select>
                                ...
                                @if(!empty($cont_rev_docs))
                                <div class="col-sm-2">
                                  <label>
                                    In Review Docs
                                  </label>
                                  <select class="form-control">
                                      @foreach($cont_rev_docs as $doc)
                                      <option value="{{$doc->id}}">{{$doc->doc_number}}</option>
                                      @endforeach
                                    </select>
                                </div>
                                @endif
                                ...
                                <div class="col-sm-2">
                                  ...
                                  <input type="text" name="review_date" class="form-control" id="original_datepicker">
                                </div>
                                <div class="col-sm-2">
                                  <label>
                                    Due Date
                                  </label>
                                  <input type="text" name="due_date" class="form-control" id="effective_datepicker">
                                </div>
                                <div class="col-sm-2">
                                  <label>
                                    Completion Date
                                  </label>
                                  <input type="text" name="completed_date" class="form-control" id="review_datepicker">
                                </div>
                              </div>
                            </div>
                            <!-- /.container-fluid -->
