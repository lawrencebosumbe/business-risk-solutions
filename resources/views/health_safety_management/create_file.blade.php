            ...
            <div class="card">
              ...
              <div class="card-header card-header-sub-top d-flex p-0">
                ...
                <ul class="nav nav-pills ml-auto p-2">
                  <li class="nav-item">
                    <a class="nav-link active" href="{{ route('health_safety_management.create_folder') }}" >Add Folder
                    </a>
                  </li>
                  <li class="nav-item">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card card-default ">
                          ...
                          <div class="card-body">
                            ...
                            <!-- form -->
                            <form action="{{ route('health_safety_management.insert_file') }}" method="post" enctype="multipart/form-data">
                            <!-- Cross-site Request Forgery -->
                            <!-- protecting the site for csrf attacks -->
                                @csrf
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                      <input type="radio" name="type"> Web
                                    </div>
                                    <!-- /.form-group -->
                                    <!-- .form-group -->
                                    <div class="form-group">
                                      <input type="radio" name="type"> Url
                                    </div>
                                    <!-- /.form-group -->
                                  </div>
                                  <!-- /.col -->
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                      ...
                                      <div class="form-group">
                                        <input type="text" 
                                        name="filename" id="filename" class="form-control">
                                      </div>
                                  </div>
                                  <!-- /.col -->     
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <!-- .form-group -->
                                    <div class="form-group">
                                      <input type="radio" name="ownership_type"> Owner
                                    </div>
                                    <!-- /.form-group -->
                                    <!-- .form-group -->
                                    <div class="form-group">
                                      <input type="radio" name="ownership_type"> Copyright
                                    </div>
                                    <!-- /.form-group -->
                                  </div>
                                  <!-- /.col -->
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" id="resource_date" name="resource_date" class="form-control" autocomplete="off">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="review_date">Review Date</label>
                                        <input type="text" id="review_date" name="review_date" class="form-control" autocomplete="off"> 
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6 folder-actions">
                                    <ul>
                                      ...
                                      <li>
                                        <button class="btn btn-primary" type="Cancel"> Cancel
                                        </button>
                                      </li>
                                    </ul>
                                  </div>
