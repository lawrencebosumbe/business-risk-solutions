...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-light bg_color">
    ...
    <!-- Authentication Links -->
      ...
      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
        ...
        <a class="dropdown-item" href="{{ route('health_safety_management.settings') }}">Settings
        </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('health_safety_management') }}" class="nav-link">
              ...
              <div class="row mb-2">
                ...
                <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                    <li class="nav-item d-none d-sm-inline-block">
                      <a href="{{ route('health_safety_management.insert_task') }}" class="nav-linkbtn btn btn-primary btn-sm">Add Task</a>
                    </li>
                    <li class="nav-item d-none d-sm-inline-block">
      ...
      <div class="container-fluid" style="margin-top: -42px">
        ...
        <div style="position: absolute; top: 135px; left: 77%; z-index: 999; width: 20%; margin-left: 15px; margin-bottom: 125px">
            ...
            <div class="card">
                  <div class="card-header tag-title-bg">
                    <div class="d-flex">
                      <h3 class="card-title text-center">Project Members</h3>
                    </div>
                  </div>
                  <div class="card-body">
                    <div class="position-relative mb-4">
                        ...
                        <div class="item col-xs-4 col-lg-4">
                          ...
                          <div class="thumbnail card">
                            <div class="img-event">
                              ...
                              <a href="{{ route('health_safety_management.folder, folder->id') }}">
  ...
  <div class="modal fade" id="notes">
    <form action="{{ route('health_safety_management.insert_note') }}" method="post">      
      @csrf
